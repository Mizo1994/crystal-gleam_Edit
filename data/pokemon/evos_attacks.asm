...
BeedrillEvosAttacks:
	...
	db 47, DRILL_PECK ; Fell Stinger → LGPE move
	db -1 ; no more level-up moves
...
SentretEvosAttacks:
	...
	db 4, DEFENSE_CURL
	db 7, QUICK_ATTACK
	db 10, FURY_STRIKES ; Fury Swipes → similar move
	db 14, DIZZY_PUNCH ; Helping Hand → event move
	db 17, SUPER_FANG ; Follow Me → HGSS tutor move
	db 20, HEADBUTT ; Slam → tutor move
	db 24, REST
	db 27, SUCKER_PUNCH
	db 27, ICE_PUNCH
	db 27, THUNDERPUNCH
...
UrsalunaBloodmoonEvosAttacks:
	...
	db 44, REST
	db 48, EARTH_POWER
	db 52, NIGHT_SLASH ; Snore → egg move
	db 58, MOONBLAST
